<%-- 
    Document   : Excluir_Categoria
    Created on : 14/06/2019, 09:05:43
    Author     : mathe
--%>
                        ...
                        <ul class="collapsible">
                            <li>
                                ...
                                <div class="collapsible-body light-blue lighten-5 light-blue-text">
                                    <a href="CategoriaServlet?acao=excluir&id=<%=categoria.getId()%>" class="light-blue-text">Id: <%=categoria.getId()%><br> Nome: <%=categoria.getNome()%></a>
                                </div>
                                <%
                                    }
                                %>
