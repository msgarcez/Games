<%-- 
    ...
    Created on : 14/06/2019, 15:02:12
    Author     : mathe
--%>
                ...
                <div class="row">
                    ...
                    <div class="col s3">
                        <div class="card z-depth-3">
                            <form method="post" action="ProdutoServlet?acao=Excluir_Produto&id=<%=produto.getId()%>">
                                ...
                                <div class="buttons-set form-buttons">
                                    <button class="waves-effect light-blue btn button" type="submit" title="Excluir"><span><span>Excluir</span></span></button>
                                </div>
                            </form>
                        </div>
                    </div>
